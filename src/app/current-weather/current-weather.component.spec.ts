...
describe('CurrentWeatherComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
       ...
       * If we have to include HttpClientTestingModule then we're not really writing
       * a unit test, because CurrentWeatherComponent shouldn't know about HttpClient
       */
